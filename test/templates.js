  ...
  describe(".md", function(){
    ...
    it("should render markdown file with partial shortcode", function(done){
      poly.render("shortcode.md", function(error, body){
        ...
        body.should.include("<h2>Hello beautifull Mexico</h2>")
        body.should.include("<p>It has 4 seasons.</p>")
        body.should.include("<h2>Hello mysterious Japan</h2>")
        body.should.include("<p>Asia</p>")
        done()
      })
    })
